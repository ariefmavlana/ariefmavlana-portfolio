<script>
  ...
  let benefits = [
    {
      name: "a self taught development",
      description:
    ...
    {
      name: "an execellent communicator",
      description:
...
<main class="flex flex-col flex-1 p-4">
  ...
  >
    <div
      class="flex flex-col lg:justify-center text-center lg:text-left gap-6 md:gap-6 lg:gap-10"
    >
      <h2 class="font-semibold text-4xl sm:text-5xl md:text-6xl">
        Hi! I'm <span class="poppins text-violet-400">Arief</span> Maulana
      ...
      <p class="text-base sm:text-lg md:text-xl">
        ...
        (NEXT.JS, NUXT.JS and SvelteKit), TailwindCSS, Laravel, Node.js + Express.js
        & MySQL, PostgresSQL and Firebase/Firestore
      </p>
      <a
      ...
      >
        ...
        <h4 class="relative z-9">Get in touch &rarrfs;</h4>
      </a>
    </div>
  ...
  <section id="projects" class="py-20 lg:py-32 flex flex-col gap-24">
    ...
    >
      <i class="fa-reguler fa-circle-play"></i>
      <p>Take a Look the Project</p>
    </a>
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-10">
      <Step step={steps[0]}
        ><p>
          HRIS Application is platform or tool created with <strong
            class="text-violet-400"
            >Laravel 11, Nuxt.js 3, Node.js and MySQL</strong
          > is able to store data and provide tracking and analysis of employee data.
        </p></Step
      >
      <Step step={steps[1]}
        ><p>
          Ultimate Todos is Fullstack <strong class="text-violet-400"
            >React.js, Node.js and Firebase</strong
          > CRUD application that allows a user to login, manage a tidy and effecacious
          todo list and presist this information across all devices.
        </p></Step
      >
      <Step step={steps[2]}
        ><p>
          The Pokemondex is a <strong class="text-violet-400"
            >React.js and TailwindCSS</strong
          >
          web application, that consume and cache the
          <strong class="text-violet-400">Pokemon API</strong> to display pokemon
          information.
        </p></Step
      >
    </div>
