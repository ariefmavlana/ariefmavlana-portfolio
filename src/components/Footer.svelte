...
>
  ...
  <div class="flex flex-col gap-4 items-center justify-center">
    ...
    <p><b class="pr-2">Email</b> ariefmavlana8@gmail.com</p>
    <p>
      <b class="pr-2">GitHub</b>
      <a
        href="https://github.com/ariefmavlana"
        target="_blank"
        class="text-violet-400"
        >ariefmavlana<sup class=""
    ...
    <p>
      ...
      <a
        href="https://www.linkedin.com/in/arief-maulana-330142137/"
        target="_blank"
        class="text-violet-400"
        >arief-maulana-330142137k<sup class=""
          ><span class="text-xs scale-75 pl-0.5"
            ><i
              class="fa-solid fa-arrow-up-right-from-square text-xs scale-[75%]"
            /></span
